                            ...
                            <div className="d-flex flex-wrap align-items-center">
                                ...
                                <div className="awesomeCo" id="awesomeCoCopy">
                                    ...
                                    <h3 className="sub-heading">
                                        ...
                                        <Badge pill variant="warning" className="badge-font">3rd party API</Badge>
                                        <Badge pill variant="warning" className="badge-font">JS Plugins</Badge>
                                        <Badge pill variant="warning" className="badge-font">JavaScript</Badge>
                                        <Badge pill variant="warning" className="badge-font">Fetch</Badge>
                                        <Badge pill variant="warning" className="badge-font">Sass</Badge>
                                        <Badge pill variant="warning" className="badge-font">SVG Animation</Badge>
                                    </h3>
