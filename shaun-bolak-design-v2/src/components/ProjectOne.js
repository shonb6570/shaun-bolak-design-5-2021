                            ...
                            <div className="d-flex flex-wrap align-items-center">
                                ...
                                <div className="awesomeCo" id="awesomeCoCopy">
                                    ...
                                    <h3 className="sub-heading">
                                        ...
                                        <Badge pill variant="warning" id="badgeFont" className="mr-2 mt-4 mb-1">3rd party API</Badge>
                                        <Badge pill variant="warning" id="badgeFont" className="mr-2 mb-1">JS Plugins</Badge>
